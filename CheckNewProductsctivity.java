...
public class CheckNewProductsctivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_check_new_productsctivity);
                    ...
                    protected void onBindViewHolder(@NonNull ProductViewHolder holder, int position, @NonNull Products model) {
                        ...
                        holder.itemView.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                    ...
                                    AlertDialog.Builder builder = new AlertDialog.Builder(CheckNewProductsctivity.this);
        ...
        unverifiedproductsRef.child(productID).child("productState").setValue("Approved")
                .addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        ...
                        {
                            Toast.makeText(CheckNewProductsctivity.this, "That item has been approved, and it is now available for sale", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
    }
