...
public class AdminMaintainProductsActivity extends AppCompatActivity {
    ...
    private void applyChanges()
    {
        ...
        if(pName.equals(""))
        {
            Toast.makeText(this, "Write down the product name", Toast.LENGTH_SHORT).show();
        }
        else if(pPrice.equals(""))
        {
            Toast.makeText(this, "Write down the product price", Toast.LENGTH_SHORT).show();
        }
        else if(pDescription.equals(""))
        {
            Toast.makeText(this, "Write down the product Description", Toast.LENGTH_SHORT).show();
        }
        else
        {
